...
class _WalletPageState extends State<WalletPage> {
  final transactions = <TransactionModel>[topup1, programTransaction, yogTransaction, topup2, topup3];
  int currentTab = 0;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const TopUpCard(balance: "10 000.50",),
            const SizedBox(height: 30),
            Text('transactions_details'.tr, 

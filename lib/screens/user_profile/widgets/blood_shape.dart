...
class BloodDesign extends GetView<OnBoardingController> {
  final String text;
  const BloodDesign({Key? key, required this.text}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => GestureDetector(
          onTap: () {
            controller.bloodtype.value = text;
          },
          child: SizedBox(
            ...
            child: CustomPaint(
              ...
              painter: RPSCustomPainter(
                  ...
                  borderWidth: controller.bloodtype.value == text ? 4 : 2,
                  border: controller.bloodtype.value == text
                      ? Constants.pColor
                      : Constants.highlight),
              child: Container(

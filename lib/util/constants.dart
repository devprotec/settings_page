...
static Color accentPurpleLight = const Color(0xFFEFDAF7);
  static Color accentPurple = const Color(0xFF8E44AD);
  static Color purple = const Color(0xFF454E90);
...
static String get endpoint {
    //final env = dotenv.get("ENVIRONMENT");
    // if (env == "dev") {
    //   return "https://stagingapis.myhealthcop.com/";
    // }
    return "https://stagingapis.myhealthcop.com/";
  }

  static Widget emptyEvents() {
    return Column(
      children: [
